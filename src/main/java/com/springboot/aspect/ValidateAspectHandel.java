...
import com.springboot.annotation.ValidateFiled;
import com.springboot.annotation.ValidateGroup;
 ...
 * @Author: chuan.bai
 * @Description
 * @Date: Created on 15:50 01/12/2017
 * @Modified By:
 */
@Component
@Aspect
public class ValidateAspectHandel {
    ...
    @Around("@annotation(com.springboot.annotation.ValidateGroup)")
